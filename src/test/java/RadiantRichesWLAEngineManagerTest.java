...
public class RadiantRichesWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(RadiantRichesWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/RadiantRichesWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/RadiantRichesWLAIW/InitOutcome.xml").getDocumentElement();
